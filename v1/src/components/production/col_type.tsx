        ...
        <Grid xs={12} md={6} lg={4} xl={4}>
            <Card sx={{padding:'20px'}}>
                <CardContent>
                    ...
                    <Accordion sx={{shadow: 'none', boxShadow: 'none', padding: '0', backgroundColor: 'var(--joy-palette-background-surface)', backgroundImage: 'none'}}>
                        <AccordionSummary
                            sx={{padding: '0'}}
                                    ...
                                    <Link to={"/building"} state={{data: factory}} style={{textDecoration: 'none'}}>
                                        <Card variant="outlined" sx={{padding: '15px', marginBottom: '10px'}}>
                                            <Grid container display={'flex'} alignItems={'center'} sx={{marginBottom: '15px'}}>
                                                ...
                                                <Grid>
                                                    {factory.IsConfigured === true && factory.IsProducing === true && factory.IsPaused === false ? <Chip size="sm" color="success">ON</Chip> : <Chip size="sm" color="danger" >OFF</Chip>}
                                                </Grid>
                                            </Grid>
                                            <Grid container display={'flex'} alignItems={'center'}>
                                                ...
                                                <Grid>
                                                    <Typography level="body2">{factory.Recipe}</Typography>
                                                </Grid>
                                            </Grid>
                                        </Card>
                                    </Link>
