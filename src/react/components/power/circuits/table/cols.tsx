...
export const powerCircuitsCols: ColumnDef<PowerFm>[] = [
	{
		accessorKey: "id",
		header: ({ column }) => <HeaderCell column={column} title="Circuit-ID" />,
	...
	},
	{
		...
		cell: ({ row }) => (
			<BooleanStatusCell
				row={row}
				selector="fuseTriggered"
				successMsg="All OK"
				errorMsg="Fuse Broken!"
				invert
			/>
		),
	},
	{
		...
		header: ({ column }) => <HeaderCell column={column} title="Production" />,
		cell: ({ row }) => (
			<NumberCell row={row} suffix="MW" selector="powerProduction" />
		),
	},
	{
		accessorKey: "powerConsumed",
		header: ({ column }) => <HeaderCell column={column} title="Consumption" />,
		cell: ({ row }) => (
			<NumberCell row={row} suffix="MW" selector="powerConsumed" />
		),
	},
	{
		...
		header: ({ column }) => <HeaderCell column={column} title="Consumption" />,
		cell: ({ row }) => {
			const prod = Number.parseFloat(row.getValue("powerProduction"));
			const cons = Number.parseFloat(row.getValue("powerConsumed"));
			...
			return <PercentageCell perc={perc} color />;
		},
	},
	{
		...
		cell: ({ row }) => (
			<NumberCell row={row} suffix="MW" selector="powerMaxConsumed" />
		),
	},
	{
		...
		cell: ({ row }) => (
			<NumberCell row={row} suffix="MW" selector="batteryCapacity" />
		),
	},
];
