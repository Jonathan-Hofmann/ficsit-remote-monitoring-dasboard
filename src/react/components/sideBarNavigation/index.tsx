							...
							{subMenus.map((menu) => {
								return (
									<Collapsible
										...
										open={
											openedMenus.includes(menu.title) ||
											path.includes(menu.basePath)
										}
									...
									>
										<SidebarMenuItem>
											<CollapsibleTrigger asChild>
												<SidebarMenuButton
													isActive={path.includes(menu.basePath)}
												>
													<menu.icon />
				...
				<SidebarMenu>
					...
					<SidebarMenuItem>
						<SidebarMenuButton asChild>
							<a
								href={
									"https://github.com/Jonathan-Hofmann/ficsit-remote-monitoring-dasboard"
								}
							>
								<FaGithub />
