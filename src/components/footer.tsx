            ...
            <Grid container>
                ...
                <Grid xs>
                    ...
                    <Typography level="body2" textAlign={'center'}>
                        Github Repository <Link style={{color:"var(--joy-palette-primary-main)", textDecoration:'none'}} target="_blank" to="https://github.com/Jonathan-Hofmann/ficsit-remote-monitoring-dasboard">here</Link>
                    </Typography>
                </Grid>
                <Grid xs >
                    <Typography textAlign={'right'} level="body2">
                        Base Mod for Satisfactory: <Link style={{color:"var(--joy-palette-primary-main)", textDecoration:'none'}} target="_blank" to="https://ficsit.app/mod/FicsitRemoteMonitoring">Ficsit Remote Monitoring</Link>
                    </Typography>
                </Grid>
            </Grid>
